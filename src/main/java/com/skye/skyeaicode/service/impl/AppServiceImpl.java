package com.skye.skyeaicode.service.impl;
...
import com.skye.skyeaicode.ai.AiCodeGenTypeRoutingService;
import com.skye.skyeaicode.ai.AiCodeGenTypeRoutingServiceFactory;
...
import com.skye.skyeaicode.mapper.AppMapper;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App>  implements AppService{
    ...
    public Flux<String> chatToGenCode(Long appId, String message, User loginUser) {
        //参数校验
        ThrowUtils.throwIf(appId == null || appId<=0 || message == null || loginUser == null, ErrorCode.PARAMS_ERROR, "参数错误");
        //查询应用信息
